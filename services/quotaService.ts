...
export const KNOWN_MODEL_QUOTAS: Record<string, ModelQuotaSpec> = {
  ...
  'gemini-3.5-flash': {
    ...
    tierNote: 'Deep reasoning model. Google Free Tier strictly caps this to ~20 requests/day. Switch to Flash-Lite (1,500 RPD) or enable billing for large batches.',
    isRecommendedForVolume: false,
  },
  'gemini-3.7-flash': {
    id: 'gemini-3.7-flash',
